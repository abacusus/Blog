...
async function run(prompt) {
  console.log(prompt)
   ...
   // See https://ai.google.dev/gemini-api/docs/safety-settings
    ...
    const result = await chatSession.sendMessage("Write It Summary... "+ prompt);
...
// setBlogs(useSelector((state) => state.blogs.blogs);)
  ...
  return (
    ...
    <div style={{backgroundColor:'#09344c',height:800,zIndex:4}}>
      <img  style={{position:"absolute",height : "100%",opacity:0.1}} src={home}/>
      <div>
      ...
      <div id="main-nav" style={{ width: "100%",zIndex:5,position:"relative" }}>
        ...
        >
          ...
          >
            ...
            <p  style={{fontFamily:'roboto',color:'rgb(128, 164, 206)',cursor:"pointer"}}>MyBlog</p>
            </div>
            <div style={{}} id="bell">
            ...
            >
              <img style={{ height: 16 ,color:'rgb(128, 164, 206)'}} src={page} />
              <p  style={{fontFamily:'roboto',color:'rgb(128, 164, 206)',cursor:"pointer"}}>Write</p>
            </div>
            {image == null ? (
          <div
        ...
        >
          ...
          <div
            ...
            onMouseLeave={()=>setHover([false,false,false,false,false,false])}
            style={{
              display: "flex",
    ...
    <div style={{ paddingLeft : summary === "" ? 24.5 :0 
      ,width:"100%",display:"flex",flexDirection:"row",justifyContent:summary === "" ?"flex-start":"space-around",paddingTop: 20}}>
       <div style={{ width:"60%"}}>
         {
        blogs?.blogs?.map((element,index)=>{
          return(
            ...
            onMouseEnter={()=>{
             ...
             style={{gap : 20,zIndex:4,position:"relative",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%",paddingLeft:10}}>
          ...
          >
            {blogs.image ? "" : blogs?.name?.charAt(0)?.toUpperCase()}
              ...
              <h1 style={{display:'flow',margin:0,color:"white",fontFamily:'roboto'}}>
                {
                  element.title
                }
              </h1>
              <p style={{width:"100%",fontSize:16.5,color:"white",fontFamily:'roboto'}}>
                {
                  element.blogData[0].text
                }
              </p>
              <div style={{display:"flex",alignItems:'center',gap:6}}>
        <img style={{opacity:0.7,height:20,width:30,}} src={like}/>
        <img style={{opacity:0.7,height:20,width:20}} src={commment}/>
        <img style={{opacity:0.6,height:20,width:20,marginLeft:5}} src={bookmark}/>
        </div>
              </div>
              <div>
                <img style={{height:200}} src={
       ...
       <div style={{  display : summary != "" ? "flex" : "none",
       justifyContent : "center",
       alignItems : "center",
        backgroundColor: "rgba(13, 29, 47, 0.5)",
    boxShadow: "0px 10px 30px rgba(0, 0, 0, 0.1)",
    borderRadius: "16px",
    transition: "transform 0.3s ease",width:"30%",paddingLeft:30}}>
        <p style={{color:"white", fontFamily: "Segoe UI, sans-serif"}}>{summary}</p>
       </div>
    </div>
